            ...
            <div className='w-full'>
                ...
                <div className='w-full flex items-center justify-center'>
                    <div className='w-[95%] flex items-center justify-between'>
                        <h1 className='text-2xl font-bold'>Popluar right now</h1>
                        <div className='flex items-center gap-3'>
                            <Link to={'/discounted-deals/all'} className=' text-sky-500 md:pr-2'>See all</Link>
                            <div className="swiper-button-prev-popular hidden md:!block bg-sky-200 cursor-pointer hover:scale-105 text-sky-500 rounded-full p-2">
                                <AiOutlineArrowLeft />
                            </div>
                            <div className="swiper-button-next-popular hidden md:!block bg-sky-200 cursor-pointer hover:scale-105 text-sky-500 rounded-full p-2">
                                <AiOutlineArrowRight />
                            </div>
                        </div>
                    </div>

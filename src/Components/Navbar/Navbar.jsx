...
const Navbar = () => {
    ...
    return (
        <div className={location.pathname === "/en/discovery" && "shadow-md pb-3.5 md:pb-0 w-full"}>
            <div className={location.pathname === "/en/discovery" ? 'flex fixed top-0 left-0 z-50 bg-white md:shadow-md items-center px-3 md:px-0 justify-center w-full py-3 text-black ' : 'flex items-center justify-center fixed top-0 shadow-md left-0 w-full py-3 px-3 bg-white text-black z-50'}>
            ...
            <div className='md:hidden fixed left-0 bg-white w-full z-50 top-16 py-2 shadow-md px-5'>

            ...
            <div className='w-full'>
                ...
                <div className='w-full flex items-center justify-center'>
                    <div className='w-[95%] flex items-center justify-between'>
                        <h1 className='text-2xl font-bold'>Discounts up to 50% 🤩</h1>
                        <div className='flex items-center gap-3'>
                            <Link to={'/discounted-deals/all'} className=' text-sky-500 md:pr-2'>See all</Link>
                            <div className="swiper-button-prev-discounted-deals hidden md:!block bg-sky-200 cursor-pointer hover:scale-105 text-sky-500 rounded-full p-2">
                                <AiOutlineArrowLeft />
                            </div>
                            <div className="swiper-button-next-discounted-deals hidden md:!block bg-sky-200 cursor-pointer hover:scale-105 text-sky-500 rounded-full p-2">
                                <AiOutlineArrowRight />
                            </div>
                        </div>
                    </div>
                ...
                <div className='w-full flex items-center'>
                    <div className='w-full pl-2 sm:pl-3 md:pl-4 lg:pl-6 xl:pl-7 pt-5'>
                        <Swiper
                            ...
                            navigation={{
                                nextEl: '.swiper-button-next-discounted-deals',
                                prevEl: '.swiper-button-prev-discounted-deals',
                            }}

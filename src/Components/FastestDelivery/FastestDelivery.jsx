                ...
                <div className='w-full flex items-center justify-center'>
                    <div className='w-[95%] flex items-center justify-between'>
                        ...
                        <div className='flex items-center gap-3'>
                            ...
                            <div className="swiper-button-prev-fastest-delivey hidden md:!block bg-sky-200 cursor-pointer hover:scale-105 text-sky-500 rounded-full p-2">
                                <AiOutlineArrowLeft />
                            </div>
                            <div className="swiper-button-next-fastest-delivey hidden md:!block bg-sky-200 cursor-pointer hover:scale-105 text-sky-500 rounded-full p-2">
                                <AiOutlineArrowRight />
                            </div>
                        </div>
                    </div>
                ...
                <div className='w-full flex items-center'>
                    <div className='w-full pl-2 sm:pl-3 md:pl-4 lg:pl-6 xl:pl-7 pt-5'>
                        <Swiper
                            ...
                            navigation={{
                                nextEl: '.swiper-button-next-fastest-delivey',
                                prevEl: '.swiper-button-prev-fastest-delivey',
                            }}
